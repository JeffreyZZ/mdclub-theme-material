    ...
    <div class="mdui-card mdui-card-shadow article">
      ...
      <div class="mc-user-line">
        <div class="mc-user-popover">
          <a class="avatar user-popover-trigger" href="<?= get_root_url() ?>/users/<?= $article['user_id'] ?>" style="background-image: url(<?= $article['relationships']['user']['avatar_text']['middle'] ?? '' ?>);"></a>
